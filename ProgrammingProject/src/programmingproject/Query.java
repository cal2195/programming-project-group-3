...
public class Query
{
    ...
    {
        return getTrips("SELECT * FROM taxi_data WHERE vendor_id != 'VTS' AND pickup_datetime > " + DateTime.SECONDS_TILL_MONTH_STARTS[month - 1] + " AND pickup_datetime < " + DateTime.SECONDS_TILL_MONTH_STARTS[month] + " LIMIT 0," + limit);
    }
