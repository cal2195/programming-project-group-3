...
public class Trip {
    //store_and_fwd_flag should be a boolean, storing as string atm because it's Y/N in the csv
     ...
     Trip(String pickupTime, String dropoffTime, 
             String storeAndFwdFlag, int rateCode, int passengers, int time, 
             double pickupLat, double pickupLong, double dropoffLat, double dropoffLong){
